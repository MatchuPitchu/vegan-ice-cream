import { IonCard, IonCardContent, IonCardHeader, IonCardTitle, IonContent, IonIcon, IonItem, IonLabel, IonPage, isPlatform } from "@ionic/react";
  ...
  <IonPage>
    <IonContent>
      <IonCard className={`${isPlatform('desktop') ? "cardIonic" : ""}`}>
        ...
        <p className="mb-2">Sie haben das Recht, jederzeit gegen die Verarbeitung Ihrer Daten, die wir auf unser berechtigtes Interesse nach Art. 6 Abs. 1 lit. f DSGVO stützen, Widerspruch einzulegen. Sofern Sie von Ihrem Widerspruchsrecht Gebrauch machen, bitten wir Sie um die Darlegung der Gründe. Wir werden Ihre personenbezogenen Daten dann nicht mehr verarbeiten, es sei denn, wir können Ihnen gegenüber nachweisen, dass zwingende schutzwürdige Gründe an der Datenverarbeitung Ihre Interessen und Rechte überwiegen.</p>
        <p className="mb-2"><span><strong>Unabhängig vom vorstehend Gesagten, haben Sie das jederzeitige Recht, der Verarbeitung Ihrer personenbezogenen Daten für Zwecke der Werbung und Datenanalyse zu widersprechen.</strong></span></p>
        <p className="mb-2">Ihren Widerspruch richten Sie bitte an die oben angegebene Kontaktadresse des Verantwortlichen.</p>
        </IonCardContent>
        ...
        <IonCardContent>
          <p className="mb-2">Wir löschen Ihre Daten dann, wenn wir diese nicht mehr brauchen oder Sie uns dies mit einer E-Mail an matchu.pitchu.wbs@gmail.de vorgeben. Dass bedeutet, dass - sofern sich aus den einzelnen Datenschutzhinweisen dieser Datenschutzerklärung nichts anderes ergibt - wir Ihre Daten löschen,</p>
          <ul>
            <li>
        ...
        <IonCardContent>
          ...
          <p className="mb-2">Die Softwareanwendungen, die wir zu diesen Zwecken einsetzen, stellen uns der/die unten genannten Anbieter auf deren Servern zur Verfügung. Auf diese Server greifen wir über das Internet zu. Soweit Sie uns Ihre Daten im Rahmen der Kommunikation mit uns bzw. in anderweitigen von uns mittels dieser Datenschutzerklärung erläuterten Vorgängen übermitteln, verarbeiten wir diese Daten in dem von uns genutzten Clouddienst. Das bedeutet, dass Ihre Daten auf den Servern des Clouddient-Drittanbieters gespeichert werden. Die Drittanbieter verarbeiten zur Sicherung ihrer Server sowie zur Optimierung ihrer Dienstleistungen Nutzungs- und Metadaten. Wir verarbeiten und speichern insbesondere Ihre Kontakt-, Kunden- und Vertragsdaten.</p>
          <p className="mb-2">Sollten wir mittels des von uns genutzten Clouddienstes Dateien jeglicher Art öffentlich über unsere Interenetpräsenz zur Verfügung stellen, kann der jeweilige Drittanbieter des Clouddienstes Cookies auf Ihrem Computersystem speichern, sofern Sie auf diese Dateien zugreifen. Der Dienstanbieter kann die so erhobenen Daten verarbeiten, um Ihr Nutzungsverhalten bzw. Ihre Browser-Einstellungen zu analysieren.<br/><br/>Wir weisen darauf hin, dass je nach Sitzland des nachstehend genannten Diensteanbieters die nachfolgend näher benannten Daten auf Server außerhalb des Raumes der Europäischen Union übertragen und verarbeitet werden können. Es besteht in diesem Fall das Risiko, dass das von der DSGVO vorgeschriebene Datenschutzniveau nicht eingehalten und die Durchsetzung Ihrer Rechte nicht oder nur erschwert erfolgen kann. Sofern der von uns eingesetzte Diensteanbieter das Verarbeiten der Daten ausschließlich innerhalb der EU anbietet, beabsichtigen wir - sofern derzeit ohnehin nicht bereits umgesetzt - Ihre Daten ausschließlich dort zu verarbeiten.</p>
        </IonCardContent>
        ...
        <IonCardContent>
          ...
          <p className="mb-2"><strong>Betroffene Personen:</strong> Interessenten, Kommunikationspartner, Kunden, Beschäftigte (bspw. Bewerber, aktuelle und ehemalige Mitarbeiter)</p>
          <p className="mb-2"><strong>Verarbeitungszweck: </strong>Organisation der Büro- und Administrationsaufgaben</p>
          <p className="mb-2"><strong>Rechtsgrundlage:</strong> Einwilligung, Art. 6 Abs. 1 lit. a DSGVO, Vertragserfüllung und vorvertragliche Anfragen, Art. 6 Abs. 1 lit. b DSGVO, berechtigtes Interesse, Art. 6 Abs. 1 lit. f DSGVO</p>
        </IonCardContent>
        ...
        <IonCardContent>
          ...
          <p className="mb-2">erheben. Die vorgenannten Daten werden als Logfiles auf den Servern unseres Anbieters gespeichert. Dies ist erforderlich, um die Stabilität und Sicherheit des Betriebs unserer Internetseite zu gewährleisten.</p>
          <p className="mb-2"><strong>Betroffene Daten:</strong></p>
          <ul>
          ...
          <p className="mb-2"><strong>Betroffene Personen: </strong>Nutzer:innen unserer Internetpräsenz</p>
          <p className="mb-2"><strong>Verarbeitungszweck: </strong>Ausspielen unserer Internetseiten, Gewährleistung des Betriebs unserer Internetseiten</p>
          <p className="mb-2"><strong>Rechtsgrundlage:</strong> Berechtigtes Interesse, Art. 6 Abs. 1 lit. f DSGVO</p>
          <p className="mb-2"><strong>Von uns beauftragte(r) Webhoster: netlify für https://eis-mit-stil.netlify.app und Google Playstore für die Android App https://play.google.com/store/apps/details?id=eismitstil.app</strong></p>
        </IonCardContent>
        ...
        <IonCardContent>
          <p className="mb-2">Wir benutzen zum Ausspielen unserer Internetseiten ein Content-Delivery-Network (CDN). Ein CDN ist ein Netz regional verteilter und über das Internet verbundener Server. Über das CDN werden skalierende Speicher- und Auslieferungskapazitäten zur Verfügung gestellt. Hierdurch werden die Ladezeiten unserer Internetseiten optimiert und auch bei großen Lastspitzen ein optimaler Datendurchsatz gewährleistet. Nutzeranfragen auf unseren Internetseiten werden über Server des CDN geleitet. Aus diesen Datenströmen werden Statistiken erstellt. Dies dient zum einen dazu, potentielle Bedrohungen für unsere Internetseiten durch Schadsoftware frühzeitig zu erkennen und zum anderen unser Angebot stetig zu verbessern und unsere Internetseiten für Sie als Nutzer nutzerfreundlicher auszugestalten.</p>
          <p className="mb-2">Wir möchten Sie darauf hinweisen, dass je nach Sitzland des unten genannten Diensteanbieters die über den Dienst erfassten Daten außerhalb des Raumes der Europäischen Union übertragen und verarbeitet werden können. Es besteht in diesem Fall das Risiko, dass das von der DSGVO vorgeschriebene Datenschutzniveau nicht eingehalten und die Durchsetzung Ihrer Rechte nicht oder nur erschwert erfolgen kann.</p>
          <p className="mb-2"><strong>Betroffene Daten:</strong></p>
          <ul>
          ...
          <p className="mb-2"><strong>Verarbeitungszweck: </strong>Technische Optimierung der Internetpräsenz, Analyse von Fehlern und Nutzerverhalten</p>
          <p className="mb-2"><strong>Rechtsgrundlage:</strong> Berechtigtes Interesse, Art. 6 Abs. 1 lit. f DSGVO</p>
          <p className="mb-2"><strong>Eingesetze CDN-Dienstleister: Bootstrap 5 CSS-Abruf zum Styling der App https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta3/dist/js/bootstrap.bundle.min.js und EmailJS Kontaktformular Provider https://cdn.jsdelivr.net/npm/emailjs-com@2/dist/email.min.js</strong></p>
        </IonCardContent>
        ...
        <IonCardContent>
          ...
          <p className="mb-2"><strong>Betroffene Personen: </strong>Interessenten, Kunden, Geschäfts- und Vertragspartner</p>
          <p className="mb-2"><strong>Verarbeitungszweck: </strong>Kommunikation sowie Beantwortung von Kontaktanfragen, Büro und Organisationsverfahren</p>
          <p className="mb-2"><strong>Rechtsgrundlage:</strong> Vertragserfüllung und vorvertragliche Anfragen, Art. 6 Abs. 1 lit. b DSGVO, berechtigtes Interesse, Art. 6 Abs. 1 lit. f DSGVO</p>
        </IonCardContent>
        ...
        <IonCardContent>
          ...
          <p className="mb-2"><strong>Verarbeitungszweck: </strong>Abwicklung vertraglicher Leistungen, Kommunikation sowie Beantwortung von Kontaktanfragen, Sicherheitsmaßnahmen.</p>
          <p className="mb-2"><strong>Rechtsgrundlage:</strong> Vertragserfüllung und vorvertragliche Anfragen, Art. 6 Abs. 1 lit. b DSGVO, rechtliche Verpflichtung, Art. 6 Abs. 1 lit. c DSGVO, berechtigtes Interesse, Art. 6 Abs. 1 lit. f DSGVO</p>
          <p className="mb-2"><strong>Löschung:</strong> Siehe hierzu den Punkt: <strong>"Wann löschen wir Ihre Daten?"</strong>. Daneben möchten wir Sie darauf aufmerksam machen, dass wir die im Rahmen der Registrierung erhobenen Daten sowie die in dem Account hinterlegten Inhaltsdaten vorbehaltlich entgegenstehender gesetzlicher Aufbewahrungspflichten löschen, sobald Sie Ihren Account löschen. Wir bitten Sie daher, sofern Sie auf die in Ihrem Account hinterlegten Inhaltsdaten auch nach der Löschung Ihres Account zugreifen wollen oder müssen, diese vor der Löschung des Accounts anderweitig zu sichern.</p>
        </IonCardContent>
        ...
        <IonCardContent>
          ...
          <p className="mb-2"><strong>Verarbeitungszweck: </strong>Leistungserfüllung vertraglicher Verpflichtungen, Kommunikation und Abwicklung von Anfragen, Einholen von Feedback, Sicherheitsmaßnahmen.</p>
        </IonCardContent>
        ...
        <IonCardContent>
          <p className="mb-2">Wir nutzen bestimmte Dienste, um über unsere Internetpräsenz bestimmte Inhalte oder Grafiken (Videos, Bilder, Musik, Schriftarten, Kartenmaterial) ausspielen zu können. Dabei verarbeiten die von uns eingesetzten Dienste die Ihnen zum Zeitpunkt Ihres Besuchs auf unseren Internetseiten zugeordnete IP-Adresse, da nur so der jeweilige Inhalt in dem von Ihnen verwendeten Browser dargestellt werden kann. Darüber hinaus können die Anbieter dieser Dienste weitere Cookies auf Ihr Endgerät setzen, über die Informationen über Ihr Nutzungsverhalten, Ihre Interessen, das von Ihnen verwendete Gerät und den verwendeten Browser sowie Zeitpunkt und Dauer Ihrer Sitzung erhoben werden. Diese Daten verwenden die Anbieter regelmäßig für Analyse-, Statistik- und Marketingzwecke. Zudem können diese Informationen können auch mit Informationen aus anderen Quellen verbunden werden. Dies gilt insbesondere dann, wenn Sie selbst einen Account bei dem Dienstanbieter unterhalten und zum Zeitpunkt der Sitzung dort eingeloggt sind.</p>
          <p className="mb-2">Wir weisen darauf hin, dass je nach Sitzland des nachstehend genannten Diensteanbieters die nachfolgend näher benannten Daten auf Server außerhalb des Raumes der Europäischen Union übertragen und verarbeitet werden können. Es besteht in diesem Fall das Risiko, dass das von der DSGVO vorgeschriebene Datenschutzniveau nicht eingehalten und die Durchsetzung Ihrer Rechte nicht oder nur erschwert erfolgen kann.</p>
          <p className="mb-2"><strong>Betroffene Daten:</strong></p>
          <ul>
            <li>Nutzungsdaten (bspw. Zugriffszeiten, angeklickte Webseiten)</li>
            <li>Kommunikationsdaten (bspw. Informationen über das genutzte Gerät, IP-Adresse)</li>
          </ul>
          <p className="mb-2"><strong>Betroffene Personen: </strong>Nutzer unserer Internetpräsenz</p>
          <p className="mb-2"><strong>Verarbeitungszweck: </strong>Ausspielen unserer Internetseiten, Anbieten von Inhalten, Gewährleistung des Betriebs unserer Internetseiten</p>
          <p className="mb-2"><strong>Rechtsgrundlage:</strong> Einwilligung über Cookie-Consent-Banner, Art. 6 Abs. 1 lit. a DSGVO, berechtigte Interessen, Art. 6 Abs. 1 lit. f DSGVO</p>
          <p className="mb-2"><strong>Wir nutzen folgende Content-Dienste:</strong></p>
        ...
        <IonCardContent>
          <p className="mb-2">Wir treffen im Übrigen technische und organisatorische Sicherheitsmaßnahmen nach dem Stand der Technik, um die Vorschriften der Datenschutzgesetze einzuhalten und Ihre Daten gegen zufällige oder vorsätzliche Manipulationen, teilweisen oder vollständigen Verlust, Zerstörung oder gegen den unbefugten Zugriff Dritter zu schützen.</p>
          <p className="mb-2"><strong>Aktualität und Änderung dieser Datenschutzerklärung</strong></p>
          <p className="mb-2">Diese Datenschutzerklärung ist aktuell gültig und hat den Stand Juni 2021. Aufgrund geänderter gesetzlicher bzw. behördlicher Vorgaben kann es notwendig werden, diese Datenschutzerklärung anzupassen.</p>
          <p className="mb-2"><strong>Diese Datenschutzerklärung wurde mit Hilfe des Datenschutz-Generators von SOS Recht erstellt. SOS Recht ist ein Angebot der Mueller.legal Rechtsanwälte Partnerschaft mit Sitz in Berlin.</strong></p>
        </IonCardContent>
      </IonCard>
    </IonContent>
  </IonPage>
