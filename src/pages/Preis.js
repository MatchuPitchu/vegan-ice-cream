...
import { IonButton, IonCard, IonCardContent, IonCardTitle, IonContent, IonHeader, IonIcon, IonInput, IonItem, IonLabel, IonPage, IonRange } from '@ionic/react';
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <IonItem lines="none" className="mb-1">
              ...
              <IonInput 
                readonly
                type="text"
                value={searchSelected ? `${searchSelected.name} in ${searchSelected.address.city}` : ''}
              />
            </IonItem>
            ...
            <IonButton fill="solid" className="check-btn my-3" type="submit">
              <IonIcon className="pe-1" icon={add}/>Kugelpreis eintragen
            </IonButton>
          </form>
        </div>
      ) : (
