  ...
  <IonPage>
    <IonContent>
      <IonCard className={`${isPlatform('desktop') ? 'card--ionic' : ''}`}>
        ...
        <IonCardContent>
          <p className='mb-2'>
            Ich habe die Datenschutzerklärung nach bestem Wissen und Gewissen mit einem mir online
            zur Verfügung stehenden Generator erstellt und leicht an meine App angepasst.
          </p>
          <p className='mb-2'>
          ...
          <ul>
            <li>
              ...
              und erfasse Sie nur wirklich dort wie bei der Registrierung, wo es mir geboten
              scheint, um Missbrauch wie z.B. bewusst falsche Bewertungen und Eingaben von Eisläden
              vorzubeugen.
            </li>
            <li>
              ...
              zumeist damit verbunden, dass diese Unternehmen Daten erfassen und kommerzialisieren.
              So nutzen wir verschiedene wie z.B. Google Maps Dienste (Map, Autocomplete-Funktion,
        ...
        <IonCardContent>
          <p className='mb-2'>
            ...
            Datenschutzerklärung gilt für alle von uns vorgenommene Daten-Verarbeitungsvorgänge
        ...
        <IonCardContent>
          <p className='mb-2'>
            Nach der DSGVO stehen Ihnen die nachfolgend aufgeführten Rechte zu, die Sie jederzeit
            bei dem oben dieser Datenschutzerklärung genannten Verantwortlichen geltend machen
            können:
          </p>
          <ul>
            <li>
            ...
            <li>
              <strong>Recht auf Datenübertragbarkeit:</strong> Sie haben das Recht zu verlangen,
              dass wir Ihnen oder einem anderen Verantwortlichen Ihre Daten in einem strukturierten,
            ...
            <li>
              ...
              zu beschweren. Zuständig ist die Aufsichtsbehörde Ihres üblichen Aufenthaltsortes,
              Ihres Arbeitsplatzes oder unseres Firmensitzes.
            </li>
          </ul>
        </IonCardContent>
        ...
        <IonCardContent>
          ...
          <p className='mb-2'>
            <span>
              <strong>
                Unabhängig vom vorstehend Gesagten, haben Sie das jederzeitige Recht, der
                Verarbeitung Ihrer personenbezogenen Daten für Zwecke der Werbung und Datenanalyse
                zu widersprechen.
              </strong>
            </span>
          </p>
        ...
        <IonCardContent>
          <p className='mb-2'>
            ...
            einer E-Mail an matchu.pitchu.wbs@gmail.de vorgeben. Dass bedeutet, dass - sofern sich
            aus den einzelnen Datenschutzhinweisen dieser Datenschutzerklärung nichts anderes ergibt
          ...
          <p className='mb-2'>
            Sofern wir (bestimmte Teile) Ihre(r) Daten jedoch noch für andere Zwecke vorhalten
            müssen, weil dies etwa steuerliche Aufbewahrungsfristen (in der Regel 6 Jahre für
            Geschäftskorrespondenz bzw. 10 Jahre für Buchungsbelege) oder die Geltendmachung,
            Ausübung oder Verteidigung von Rechtsansprüchen aus vertraglichen Beziehungen (bis zu
            vier Jahren) erforderlich machen oder die Daten zum Schutz der Rechte einer anderen
            natürlichen oder juristischen Person gebraucht werden, löschen wir (den Teil) Ihre(r)
            Daten erst nach Ablauf dieser Fristen. Bis zum Ablauf dieser Fristen beschränken wir die
        ...
        <IonCardContent>
          ...
          <p className='mb-2'>
            ...
            genannten Anbieter auf deren Servern zur Verfügung. Auf diese Server greifen wir über
            das Internet zu. Soweit Sie uns Ihre Daten im Rahmen der Kommunikation mit uns bzw. in
            ...
            ihrer Dienstleistungen Nutzungs- und Metadaten. Wir verarbeiten und speichern
            insbesondere Ihre Kontakt-, Kunden- und Vertragsdaten.
          </p>
          <p className='mb-2'>
            ...
            Union übertragen und verarbeitet werden können. Es besteht in diesem Fall das Risiko,
            dass das von der DSGVO vorgeschriebene Datenschutzniveau nicht eingehalten und die
            Durchsetzung Ihrer Rechte nicht oder nur erschwert erfolgen kann. Sofern der von uns
            eingesetzte Diensteanbieter das Verarbeiten der Daten ausschließlich innerhalb der EU
            anbietet, beabsichtigen wir - sofern derzeit ohnehin nicht bereits umgesetzt - Ihre
            Daten ausschließlich dort zu verarbeiten.
          </p>
        </IonCardContent>
        ...
        <IonCardContent>
          <ul>
            <li>
              Bestandsdaten (Name, Stadtname) - den Namen und der Stadtname in Ihrem Profil können
              Sie frei wählen; sie müssen nicht der Wahrheit entsprechen
            </li>
            <li>
              Kontaktdaten (E-Mail-Adressen) - Ihre Mailadresse wird im Rahmen der Registrierung
        ...
        <IonCardContent>
          ...
          <p className='mb-2'>
            ...
            Browser übertragenen Daten verarbeitet werden, die bei der Nutzung unserer
            Internetseiten anfallen. Hierzu gehören insbesondere Ihre IP-Adresse, die der Anbieter
            benötigt, um unser Online-Angebot an den von Ihnen genutzten Browser ausliefern zu
            können sowie sämtliche von Ihnen über unsere Internetseite getätigten Eingaben. Daneben
          ...
          <ul>
            ...
            <li>
              die Internetseite, von welcher Sie gegebenenfalls auf unsere Internetseite gelangt
              sind
            </li>
          ...
          <p className='mb-2'>
            ...
            gespeichert. Dies ist erforderlich, um die Stabilität und Sicherheit des Betriebs
          ...
          <p className='mb-2'>
            <strong>Verarbeitungszweck: </strong>Ausspielen unserer Internetseiten, Gewährleistung
        ...
        <IonCardContent>
          ...
          <p className='mb-2'>
            ...
            Verfügung stellt, und seine US-Zentrale in New York City und seine internationale
            Zentrale in Dublin hat.
            <br />
            Datenschutzerklärung:{' '}
            <a
        ...
        <IonCardContent>
          <p className='mb-2'>
            Wir benutzen zum Ausspielen unserer Internetseiten ein Content-Delivery-Network (CDN).
            Ein CDN ist ein Netz regional verteilter und über das Internet verbundener Server. Über
            das CDN werden skalierende Speicher- und Auslieferungskapazitäten zur Verfügung
            gestellt. Hierdurch werden die Ladezeiten unserer Internetseiten optimiert und auch bei
            großen Lastspitzen ein optimaler Datendurchsatz gewährleistet. Nutzeranfragen auf
            unseren Internetseiten werden über Server des CDN geleitet. Aus diesen Datenströmen
            werden Statistiken erstellt. Dies dient zum einen dazu, potentielle Bedrohungen für
            unsere Internetseiten durch Schadsoftware frühzeitig zu erkennen und zum anderen unser
            Angebot stetig zu verbessern und unsere Internetseiten für Sie als Nutzer
            nutzerfreundlicher auszugestalten.
          </p>
          <p className='mb-2'>
            Wir möchten Sie darauf hinweisen, dass je nach Sitzland des unten genannten
            Diensteanbieters die über den Dienst erfassten Daten außerhalb des Raumes der
            Europäischen Union übertragen und verarbeitet werden können. Es besteht in diesem Fall
            das Risiko, dass das von der DSGVO vorgeschriebene Datenschutzniveau nicht eingehalten
        ...
        <IonCardContent>
          ...
          <p className='mb-2'>
            <strong>Verarbeitungszweck: </strong>Kommunikation sowie Beantwortung von
        ...
        <IonCardContent>
          ...
          <p className='mb-2'>
            ...
            aus der Eingabemaske ergeben. Zu den dort abgefragten Daten gehören insbesondere Ihr
            Name, Ihre E-Mail-Adresse, ggfls. ein Nutzername sowie das Passwort. Diese Daten werden
            von uns gespeichert und verarbeitet, um für Sie ein Nutzerkonto einzurichten und die
            (wiederholte) Anmeldung zu ermöglichen. Die Daten können jederzeit durch Sie geändert
            oder gelöscht werden. Die Daten werden nicht an Dritte weitergegeben außer dies dient
            der technischen und organisatorischen Abwicklung des zwischen uns bestehenden
            Nutzungsvertrages. Um Sie und uns vor missbräuchlichen Registrierungen zu schützen, ist
            eine E-Mail-Bestätigung notwendig, wodurch Ihre Mailadresse als die Ihre bestätigt wird.
          </p>
          <p className='mb-2'>
            <strong>Betroffene Daten:</strong>
          </p>
          ...
          <p className='mb-2'>
            ...
            <strong>"Wann löschen wir Ihre Daten?"</strong>. Daneben möchten wir Sie darauf
            aufmerksam machen, dass wir die im Rahmen der Registrierung erhobenen Daten sowie die in
            dem Account hinterlegten Inhaltsdaten vorbehaltlich entgegenstehender gesetzlicher
            Aufbewahrungspflichten löschen, sobald Sie Ihren Account löschen. Wir bitten Sie daher,
            sofern Sie auf die in Ihrem Account hinterlegten Inhaltsdaten auch nach der Löschung
            Ihres Account zugreifen wollen oder müssen, diese vor der Löschung des Accounts
        ...
        <IonCardContent>
          <p className='mb-2'>
            ...
            Schmähkritik, Volksverhetzung, verbotene Gewaltdarstellung etc.) unter Umständen selbst
            in Haftung genommen werden können, speichern wir Ihre IP-Adresse für die Dauer von 7
            Tagen, um gegebenenfalls hierüber Ihre Identität ermitteln zu können.
          </p>
          <p className='mb-2'>
        ...
        <IonCardContent>
          <p className='mb-2'>
            ...
            Grafiken (Videos, Bilder, Musik, Schriftarten, Kartenmaterial) ausspielen zu können.
            Dabei verarbeiten die von uns eingesetzten Dienste die Ihnen zum Zeitpunkt Ihres Besuchs
            auf unseren Internetseiten zugeordnete IP-Adresse, da nur so der jeweilige Inhalt in dem
            von Ihnen verwendeten Browser dargestellt werden kann. Darüber hinaus können die
            Anbieter dieser Dienste weitere Cookies auf Ihr Endgerät setzen, über die Informationen
            über Ihr Nutzungsverhalten, Ihre Interessen, das von Ihnen verwendete Gerät und den
            verwendeten Browser sowie Zeitpunkt und Dauer Ihrer Sitzung erhoben werden. Diese Daten
            verwenden die Anbieter regelmäßig für Analyse-, Statistik- und Marketingzwecke. Zudem
            können diese Informationen können auch mit Informationen aus anderen Quellen verbunden
            werden. Dies gilt insbesondere dann, wenn Sie selbst einen Account bei dem
            Dienstanbieter unterhalten und zum Zeitpunkt der Sitzung dort eingeloggt sind.
          </p>
          <p className='mb-2'>
            Wir weisen darauf hin, dass je nach Sitzland des nachstehend genannten Diensteanbieters
            die nachfolgend näher benannten Daten auf Server außerhalb des Raumes der Europäischen
          ...
          <p className='mb-2'>
            ...
            auf der Google Maps eingebunden ist, wird unabhängig davon, ob die Nutzung von Google
            Maps tatsächlich erfolgt oder Sie in Ihrem Google Account eingeloggt sind Ihre
            IP-Adresse sowie Ihre Standortdaten (letztere in der Regel nicht ohne Ihre Einwilligung)
            an Google übermittelt. Ihre IP-Adresse wird Ihrem Google Account zugeordnet, sofern Sie
            bei dem Besuch unserer Internetpräsenz dort eingeloggt sind.
          </p>
          <p className='mb-2'>
          ...
          <p className='mb-2'>
            ...
            ausgeben. Die Einbindung dieser Web Fonts erfolgt durch einen Serveraufruf bei Google.
            Von dort aus werden die Schriftarten komprimiert an Ihren Browser weitergegeben und dort
        ...
        <IonCardContent>
          <p className='mb-2'>
            Wir treffen im Übrigen technische und organisatorische Sicherheitsmaßnahmen nach dem
            Stand der Technik, um die Vorschriften der Datenschutzgesetze einzuhalten und Ihre Daten
