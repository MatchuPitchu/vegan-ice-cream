...
import { IonItem, IonLabel, IonButton, IonIcon, IonCard } from '@ionic/react';
...
const SetNewPasswordContent: VFC = () => {
  const {
    control,
    handleSubmit,
    formState: { errors },
  ...
  if (isResetPasswordFinished) {
    return (
      <div className='container-content--center'>
        <IonCard>
          <IonItem lines='full'>
            <IonLabel className='text-center ion-text-wrap'>Passwort erfolgreich erneuert</IonLabel>
          </IonItem>
          <IonButton
            fill='clear'
          ...
          <CustomInput
            ...
            rules={{
              ...
              validate: {
                ...
                length: (value) => /.{6,32}/.test(value) || 'mindestens 6 Stellen lang, maximal 32',
              },
            }}
          />
        </IonItem>
